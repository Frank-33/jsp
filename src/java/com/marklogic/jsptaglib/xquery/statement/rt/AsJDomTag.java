 ...
 *  body-content="empty"
 */
public class AsJDomTag extends TagSupport
{
	...
	public int doEndTag () throws JspException
	{
		...
		if (resultSequence == null) {
			throw new JspException ("The xq:asJDom tag must be inside xq:resultSequence");
		}

		try {
			AttributeHelper.setScopedAttribute (pageContext, var,
				resultSequence.getCurrentResultAsJDom (), scope);
		} catch (XDBCException e) {
			throw new JspException ("Fetching result as JDOM", e);
		}
